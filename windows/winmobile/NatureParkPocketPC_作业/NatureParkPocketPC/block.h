...
public:
	...
	void DisplayBKG(HDC &hdc)
	{
			HDC hdcMem = CreateCompatibleDC (hdc);
			SelectObject (hdcMem, NP_BBKG_1);
			BitBlt (hdc, 0,0,240,14, hdcMem, 0, 0, SRCCOPY);
			SelectObject (hdcMem, NP_BBKG_2);
			BitBlt (hdc, 0,254,240,14, hdcMem, 0, 0, SRCCOPY);
			SelectObject (hdcMem, NP_BBKG_3);
			BitBlt (hdc, 0,14,8,240, hdcMem, 0, 0, SRCCOPY);
			SelectObject (hdcMem, NP_BBKG_4);
			BitBlt (hdc, 152,14,9,240, hdcMem, 0, 0, SRCCOPY);
			SelectObject (hdcMem, NP_BBKG_5);
			BitBlt (hdc, 233,14,7,240, hdcMem, 0, 0, SRCCOPY);
			SelectObject (hdcMem, NP_BBKG_6);
			BitBlt (hdc, 161,86,72,80, hdcMem, 0, 0, SRCCOPY);
			DeleteDC(hdcMem);
	}
	void SAVE(HANDLE &hFile)
	{
		...
		WriteFile(hFile,&need_erase,sizeof(bool),&lWrite,NULL);
		WriteFile(hFile,&next_step,sizeof(int),&lWrite,NULL);
		WriteFile(hFile,&step_length,sizeof(int),&lWrite,NULL);
		WriteFile(hFile,&time,sizeof(int),&lWrite,NULL);
		WriteFile(hFile,&DeadPosition.x,sizeof(LONG),&lWrite,NULL);
		WriteFile(hFile,&DeadPosition.y,sizeof(LONG),&lWrite,NULL);
		...
		{
			WriteFile(hFile,&CurrentMB.MBstate[i].sbposition.x,sizeof(LONG),&lWrite,NULL);
			WriteFile(hFile,&CurrentMB.MBstate[i].sbposition.y,sizeof(LONG),&lWrite,NULL);
			WriteFile(hFile,&CurrentMB.MBstate[i].sbstate,sizeof(SBState),&lWrite,NULL);
			WriteFile(hFile,&CurrentMB.MBstate[i].erasingflag,sizeof(bool),&lWrite,NULL);
		}
		...
		{
			WriteFile(hFile,&NextMB.MBstate[i].sbposition.x,sizeof(LONG),&lWrite,NULL);
			WriteFile(hFile,&NextMB.MBstate[i].sbposition.y,sizeof(LONG),&lWrite,NULL);
			WriteFile(hFile,&NextMB.MBstate[i].sbstate,sizeof(SBState),&lWrite,NULL);
			WriteFile(hFile,&NextMB.MBstate[i].erasingflag,sizeof(bool),&lWrite,NULL);
		}

		for( int i=0;i<n_width;i++)
			for(int j=0;j<n_height;j++)
			{
				WriteFile(hFile,&column[i][j].sbposition.x,sizeof(LONG),&lWrite,NULL);
				WriteFile(hFile,&column[i][j].sbposition.y,sizeof(LONG),&lWrite,NULL);
				WriteFile(hFile,&column[i][j].sbstate,sizeof(SBState),&lWrite,NULL);
				WriteFile(hFile,&column[i][j].erasingflag,sizeof(bool),&lWrite,NULL);
				WriteFile(hFile,&erase4display[i][j],sizeof(bool),&lWrite,NULL);
			}
	...
	{		
		...
		ReadFile(hFile,&need_erase,sizeof(bool),&lRead,NULL);
		ReadFile(hFile,&next_step,sizeof(int),&lRead,NULL);
		ReadFile(hFile,&step_length,sizeof(int),&lRead,NULL);
		ReadFile(hFile,&time,sizeof(int),&lRead,NULL);
		ReadFile(hFile,&DeadPosition.x,sizeof(LONG),&lRead,NULL);
		ReadFile(hFile,&DeadPosition.y,sizeof(LONG),&lRead,NULL);
		...
		for(int i=0;i<CurrentMB.max_numSB;i++)
		{
			ReadFile(hFile,&CurrentMB.MBstate[i].sbposition.x,sizeof(LONG),&lRead,NULL);
			ReadFile(hFile,&CurrentMB.MBstate[i].sbposition.y,sizeof(LONG),&lRead,NULL);
			ReadFile(hFile,&CurrentMB.MBstate[i].sbstate,sizeof(SBState),&lRead,NULL);
			ReadFile(hFile,&CurrentMB.MBstate[i].erasingflag,sizeof(bool),&lRead,NULL);
		}
		...
		for(int i=0;i<NextMB.max_numSB;i++)
		{
			ReadFile(hFile,&NextMB.MBstate[i].sbposition.x,sizeof(LONG),&lRead,NULL);
			ReadFile(hFile,&NextMB.MBstate[i].sbposition.y,sizeof(LONG),&lRead,NULL);
			ReadFile(hFile,&NextMB.MBstate[i].sbstate,sizeof(SBState),&lRead,NULL);
			ReadFile(hFile,&NextMB.MBstate[i].erasingflag,sizeof(bool),&lRead,NULL);
		}

		for( int i=0;i<n_width;i++)
			for(int j=0;j<n_height;j++)
			{
				ReadFile(hFile,&column[i][j].sbposition.x,sizeof(LONG),&lRead,NULL);
				ReadFile(hFile,&column[i][j].sbposition.y,sizeof(LONG),&lRead,NULL);
				ReadFile(hFile,&column[i][j].sbstate,sizeof(SBState),&lRead,NULL);
				ReadFile(hFile,&column[i][j].erasingflag,sizeof(bool),&lRead,NULL);
				ReadFile(hFile,&erase4display[i][j],sizeof(bool),&lRead,NULL);
			}	
